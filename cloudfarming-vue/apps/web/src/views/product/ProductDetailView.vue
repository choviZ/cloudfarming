                ...
                <div class="content-layout">
                    ...
                    <div class="detail-container">
                        <div class="sticky-tabs">
                            <div class="tab-item" :class="{ active: activeTab === 'detail' }"
                                 @click="activeTab = 'detail'">
                                商品详情
                            </div>
                            <div class="tab-item" :class="{ active: activeTab === 'reviews' }"
                            ...
                            <div v-if="activeTab === 'detail'">
                                <div class="params-table">
                                    ...
                                    <div class="params-grid">
                                        ...
                                        <div v-if="!spuInfo.baseAttrs || Object.keys(spuInfo.baseAttrs).length === 0"
                                             class="no-params">
                                            暂无详细参数
                                        </div>
                                    </div>
